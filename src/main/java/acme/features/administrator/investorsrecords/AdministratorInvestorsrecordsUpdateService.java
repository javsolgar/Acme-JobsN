...
@Service
public class AdministratorInvestorsrecordsUpdateService implements AbstractUpdateService<Administrator, Investorsrecords> {
	...
	@Override
	public void update(final Request<Investorsrecords> request, final Investorsrecords entity) {
		assert request != null;
		assert entity != null;
