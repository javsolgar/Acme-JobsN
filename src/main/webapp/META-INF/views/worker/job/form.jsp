...
<acme:form>
	...
	<jstl:set var="hasChallenge" value="${hasChallenge}"/>
	<h4><acme:menu-suboption code="authenticated.job.form.label.duties" action="/worker/descriptor/show?jobId=${jobId}"/></h4>
  	...
  	<h4><acme:menu-suboption code="worker.job.form.label.application" action="/worker/application/create?jobId=${jobId}&hasChallenge=${hasChallenge}"/> </h4>
